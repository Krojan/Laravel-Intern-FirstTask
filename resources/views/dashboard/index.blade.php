...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{asset('metronic/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('metronic/datatables.bundle.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
									...
									<div class="menu-sub menu-sub-accordion">
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link" href="{{route('dashboard_user_list')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center py-1">
									...
									<div class="me-3">
										...
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61ba8d985464a">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61ba8d985464a" data-allow-clear="true">
															<option></option>
										...
										<div class="card card-xl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61ba8d985dfcf">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-dark fw-bolder">Filter Options</div>
														</div>
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61ba8d985dfcf" data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
																		<option value="2">In Process</option>
		...
		<script src="{{asset('metronic/fullcalendar.bundle.js')}}"></script>
		<script src="{{asset('metronic/datatables.bundle.js')}}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{asset('metronic/widgets.js')}}"></script>
		<script src="{{asset('metronic/chat.js')}}"></script>
		<script src="{{asset('metronic/upgrade-plan.js')}}"></script>
		<script src="{{asset('metronic/create-app.js')}}"></script>
		<script src="{{asset('metronic/users-search.js')}}"></script>
