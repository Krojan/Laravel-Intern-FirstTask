...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
															<!--begin::Form-->
															<form id="kt_modal_add_user_form" class="form" method="POST" action="{{route('user_store')}}" enctype="multipart/form-data">
																@csrf
                                                                <!--begin::Scroll-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-600 fw-bold">
												...
												<tr>
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../demo1/dist/apps/user-management/users/view.html">
																<div class="symbol-label">
																	<img src="{{asset('images/'.$user->image_name)}}" alt="Max Smith" class="w-100" />
																</div>
															</a>
														</div>
														<!--end::Avatar-->
													...
													<!--begin::Last login=-->
													<td>
														<div class="badge badge-light fw-bolder">Last login field not set</div>
													</td>
													<!--end::Last login=-->
													<!--begin::Two step=-->
													<td></td>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="/user/delete/{{$user->id}}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
		...
		<script src="{{asset('metronic/list/table.js')}}"></script>
		<script src="{{asset('metronic/export-users.js')}}"></script>
		<script src="{{asset('metronic/add.jsR')}}"></script>
